        ...
        <div className="container mt-4 mb-5">
            ...
            {cartItems.length ? (
                                        ...
                                        <div className="col-md-9">
                                            <div className="card-body">
                                                <div className="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <h5 className="card-title text-light mb-1">{item.title}</h5>
                                                        <p className="text-muted mb-1">Quantity: {quantity}</p>
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => removeProductFromCart(item._id!, product.title)}
                ...
                <div className="text-center py-5 my-5">
                    ...
                    <Link to={cartItems.length === 0 && !localStorage.getItem("token") ? "/register" : "/products"} className="btn btn-primary btn-lg mt-3">
